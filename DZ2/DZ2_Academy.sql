...
CREATE TABLE `Academy` (
  ...
  CONSTRAINT `Departments` FOREIGN KEY (`idDepartments`) REFERENCES `Departments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2020-01-28 16:12:48
